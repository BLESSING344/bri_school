...
// change_names.php
$users = [
    ["old" => "Herman Beck", "new" => "Blessing Hope"],
    ["old" => "John Smith", "new" => "Blessing Faith"]
];

// This function replaces the old names in your HTML content
function changeUserNames($html, $users) {
    foreach ($users as $user) {
        $html = str_replace($user['old'], $user['new'], $html);
    }
    return $html;
}

// Define the original names and replacements
$name_changes = [
    "Herman Beck" => "Blessing Hope",
    "John Smith"  => "Blessing Grace"
];

// Function to replace names in HTML output
function replaceNames($html, $replacements) {
...
// Capture your HTML content (for example, from a file)
ob_start();
include('dashboard.html'); // Your HTML file name
$content = ob_get_clean();

// Replace names
$updated_content = replaceNames($content, $name_changes);
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       ...
                                       <li>
                                          ...
                                          <span>
                                          <span class="name_user">Janet Jane</span>
                                       ...
                                       <li>
                                          <span><img src="images/layout_img/msg2.png" class="img-responsive" alt="#" /></span>
                                          <span>
                                          <span class="name_user"> Smith K</span>
                                          <span class="msg_user">Sed ut perspiciatis unde omnis.</span>
                                          <span class="time_ago">12 min ago</span>
                                          </span>
                                       </li>
                                       <li>
                                          <span><img src="images/layout_img/msg3.png" class="img-responsive" alt="#" /></span>
                                          <span>
                                          <span class="name_user">John Peter</span>
                                          <span class="msg_user">On the other hand, we denounce.</span>
                                          <span class="time_ago">12 min ago</span>
                                          </span>
                                       </li>
